...
if (isset($_POST['simpan'])) {
    $nama_interest = $_POST['nama_interest'];

    $insert = mysqli_query($koneksi, "INSERT INTO interest (nama_interest) VALUES ('$nama_interest')");

    header("location:interest.php?tambah=berhasil");
}
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header"><?php echo isset($_GET['edit']) ? 'Edit' : 'Tambah' ?> Interest</div>
                                <div class="card-body">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="mb-3 row">
                                            <div class="col-sm-6">
                                                <label for="" class="form-label">Nama Interest</label>
                                                <input type="text"
                                                    class="form-control"
                                                    name="nama_interest"
                                                    placeholder="Masukkan nama ketertarikan anda"
                                                    required>
                                            </div>
                                            <!-- <div class="col-sm-6">
