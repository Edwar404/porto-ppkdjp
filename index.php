                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div
                                            ...
                                            <i
                                                class="icon-lg mdi mdi-codepen text-primary ml-auto"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div
                                            class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                                            <i
                                                class="icon-lg mdi mdi-wallet-travel text-danger ml-auto"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div
                                            class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                                            <i
                                                class="icon-lg mdi mdi-monitor text-success ml-auto"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="list-wrapper">
                                        <ul
                                            ...
                                            <li>
                                                ...
                                                <i
                                                    class="remove mdi mdi-close-box"></i>
                                            </li>
                                            <li>
                                                <div
                                                    class="form-check form-check-primary">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <i
                                                                    class="flag-icon flag-icon-au"></i>
                                                            </td>
                                                            <td>
                                                                Australia
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <i
                                                                    class="flag-icon flag-icon-ro"></i>
                                                            </td>
                                                            <td>Romania</td>
                                                            <td
                                                                class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <i
                                                                    class="flag-icon flag-icon-br"></i>
                                                            </td>
                                                            <td>Brasil</td>
                                                            <td
                                                                class="text-right">
